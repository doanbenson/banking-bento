...
function PlaidLinkButton({ onSuccess, onError, userId = 'user-sandbox', buttonText = 'Link Bank Account', variant = 'default' }) {
    ...
    const handlePlaidSuccess = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (public_token, metadata)=>{
        setLoading(true);
        try {
            console.log('Plaid Link success! Public token received:', public_token);
            console.log('Metadata:', metadata);
            console.log('Exchanging public token for access token...');
            const exchangeData = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plaidApi"].exchangePublicToken(public_token, userId);
